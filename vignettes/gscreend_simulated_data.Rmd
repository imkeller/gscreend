...
In order to estimate the effect of a specific guide RNA
on cell fitness, the relative abundances of the guide RNA
...
The count matrix contains raw guide RNA counts.
Each row represents one guide RNA, each column
